...
| `present && temperature > kHeatThresholdC` (30.0°C) | Warning | `heat` | Heat alarm (`lib/core/constants.dart`; firmware `TEMP_THRESHOLD` must match) |
...
3. Presence + temperature > **30.0°C** → heat warning (after 30s debounce).
